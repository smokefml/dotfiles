...
local mymainmenu = start_menu.mymainmenu
...
globalkeys = gears.table.join(
   ...
   -- Media Keys
    ...
    -- File Browser
    awful.key({ modkey },            "z",     function () awful.util.spawn(vars.guifileexplorer) end,
    ...
    awful.key({ modkey, "Shift" },   "b",     function () awful.util.spawn("firefox -P work") end,
              {description = "Firefox", group = "Apps"}),
    -- Music
    awful.key({ modkey },            "e",     function () awful.spawn(vars.musicplayer) end,
              {description = "Spotify", group = "Apps"}),
    -- GUI Editor
    awful.key({ modkey },            "v",     function () awful.spawn(vars.guieditor) end,
