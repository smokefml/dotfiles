...
theme.bg_normal  = "#130a0777"
theme.bg_focus   = "#872c2ccc"
theme.bg_urgent  = "#130a07dd"
...
theme.border_normal = "#130a07"
theme.border_focus  = "#c20000"
theme.border_marked = "#deb26c"
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus  = "#1e1e22"
theme.titlebar_bg_normal = "#130a07"
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = themes_path .. "blackfire/awesome-icon.png"
