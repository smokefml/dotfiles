...
-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "blackfire/blacfire-background.png"
-- }}}
...
theme.bg_normal  = "#10071377"
theme.bg_focus   = "#592c87cc"
theme.bg_urgent  = "#100713dd"
...
theme.border_normal = "#100713"
theme.border_focus  = "#6100c2"
theme.border_marked = "#deb26c"
-- }}}

-- {{{ Titlebars
theme.titlebar_bg_focus  = "#1e1e22"
theme.titlebar_bg_normal = "#100713"
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = themes_path .. "blackimperial/awesome-icon.png"
theme.arch_icon              = "/usr/share/pixmaps/archlinux-logo.svg"
